...
public class RedisClient {
	...
	/** SET 操作 */
	private void use_set(Jedis redis) {
	...
	/** LIST 操作 */
	private void use_list(Jedis redis) {
	...
	/** Hash 操作 */
	private void use_hash(Jedis redis) {
	...
	/** STRING 操作 */
	private void use_string(Jedis redis) {
	...
	/** KEY操作 */
	private void use_key(Jedis redis) {
		// KEYS
	...
	private Jedis buildConnection() {
		Jedis redis = new Jedis("192.168.6.19", 6379);// 连接redis
	...
	public static void main(String[] args) {
		// RedisClient t1 = new RedisClient();
		// t1.test1();
