...
public class DataBean2{
    ...
    public void setUseFanLi(String useFanLi) {
        this.useFanLi = useFanLi;
    }
    ...
    public String getIsShangmen() {
        return isShangmen;
    }
    public void setIsShangmen(String isShangmen) {
        this.isShangmen = isShangmen;
    }
